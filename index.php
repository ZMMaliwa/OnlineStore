...
<head>
	<meta charset="utf-8">
	<title>Maliwa's Online Store</title>
...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand"><span style='color: red'>Ma</span>liwa</a>
			</div>

			<ul class="nav navbar-nav">
				<li style="width:300px;left:10px;top:10px;"><input type="text" autocomplete="off" class="form-control" id="search" name=""></li>
	...
	<div class="one-time">
	    <div><img src="assets/images/sale3.png"></div>
	    <div><img src="assets/images/sale2.png"></div>
		<div><img src="assets/images/sale1.png"></div>
  	</div>
...
<p> Brought To You By <strong style ='color:blue'>Maliwa Industries</strong></p>
</footer></div>
